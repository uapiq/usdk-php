...
The REST API documentation can be found on [docs.uapi.nl](https://docs.uapi.nl/).
...
When the library is unable to connect to the API, or if the API returns a non-success status code (i.e., 4xx or 5xx response), a subclass of `Usdk\Core\Exceptions\APIException` will be thrown:
